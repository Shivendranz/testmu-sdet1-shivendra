...
| 2026-07-01 | Claude (claude.ai), Cursor | Fix and cleanup | Refactored environment handling for Groq/OpenAI, improved LLM reporter persistence, stabilized dashboard waits, and removed duplicate/unused artifacts. |